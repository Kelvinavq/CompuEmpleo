...
<html lang="es">
  ...
  <body>
    ...
    <main>
      <div class="textos">
        <h2>Tu próximo empleado está aquí</h2>
        <span>Ingresa y busca entre cientos de postulaciones</span>
      </div>

      <form id="formulario" action="../empresa/ingresar.php" method="post">
        <div class="grupo_input" class="grupo_input formulario_grupo" id="grupo__correo">
