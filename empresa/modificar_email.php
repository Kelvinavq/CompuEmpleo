...
<div class="fondo modal_active ">
      <div class="modal">
        ...
        <a class="btn_modal" href="../empresa/modificar_email.php">Aceptar</a>
      </div>
    </div>
...
';
        ...
        if ($actual == $emailConfirmar) {
            if ($nuevo == $nuevo2) {
                $sql = $connection->prepare("UPDATE empresa set email = '$nuevo2' WHERE id = '$id'");
                $sql->execute(); 
                echo '
                <link rel="stylesheet" href="../css/modal.css" />
...
<head>
    ...
    <title>Modificar Email - <?php echo $res['nombre'] ?></title>
