...
<head>
  ...
  <title>Inicio - <?php echo $res['nombre'] . " " . $res['apellido'] ?></title>
...
<body>
  ...
  <header>
    ...
    <a class="editar" href="editar_perfil.php">Editar</a>
    <a class="editar" href="previaPerfil.php">Vista previa del Perfil</a>
  ...
  <main>
    <div class="contenedor">
      <div class="title_editar">
        ...
        <a class="editar" href="editar_descripcion.php">Editar</a>
      </div>
    ...
    <div class="contenedor">
      <div class="title_editar">
        <h2>Mis Estudios</h2>
        <a class="editar" href="editar_estudios.php">Editar</a>
      </div>
    ...
    <div class="contenedor">
      <div class="title_editar">
        <h2>Conocimientos</h2>
        <a class="editar" href="editar_conocimientos.php">Editar</a>
      </div>
        ...
        <?php foreach ($conocimiento as $con) { ?>
          <div class="opcion">
            ...
            <form method="POST">
              ...
              <input class="btn_x" type="submit" value="X" />
            </form>
          </div>
        <?php } ?>
      </div>
    ...
    <div class="contenedor">
      <div class="title_editar">
        <h2>Idiomas</h2>
        <a class="editar" href="editar_idiomas.php">Editar</a>
      </div>
    ...
    <div class="contenedor">
      <div class="title_editar">
        ...
        <a class="editar" href="editar_curriculum.php">Editar</a>
      </div>
