...
<div class="fondo modal_active ">
      <div class="modal">
        ...
        <a class="btn_modal" href="../views/modificar_pass.php">Aceptar</a>
      </div>
    </div>
...
';
        ...
        if ($actualmd5 == $passConfirmar) {
            if ($nueva == $nueva2) {
                $sql = $connection->prepare("UPDATE usuario set pass = '$final' WHERE id = '$id'");
                $sql->execute();
                echo '
                <link rel="stylesheet" href="../css/modal.css" />
...
<head>
    ...
    <title>Modificar Contraseña - <?php echo $res['nombre'] . " " . $res['apellido'] ?></title>
